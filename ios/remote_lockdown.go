...
// ConnectRemoteLockdown opens the RSD remote lockdown service on iOS 17+
// devices. Remote lockdown connections are already authorized by RemotePairing
// and do not use usbmux StartSession.
